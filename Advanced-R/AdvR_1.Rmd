...
Older languages were "opinioned" in that they would be designed to implement only one specific programming style.
...
Go, Rust et all implement OOP and FP
...
for example map, map_dbl and related functiona form a family of functions.
